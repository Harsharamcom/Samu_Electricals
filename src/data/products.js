export const products = [
  {
    id: "prod-1",
    name: "Flame Retardant (FR) Single Core House Wire",
  ...
  {
    id: "prod-2",
    name: "Architectural 1-Way Modular Switch (6A & 16A)",
  ...
  {
    id: "prod-3",
    name: "Ultra-Slim Recessed LED Panel Light (12W / 18W)",
  ...
  {
    id: "prod-4",
    name: "Single Pole Miniature Circuit Breaker (MCB)",
  ...
  {
    id: "prod-5",
    name: "Premium Glass Finish Modular Plate (4-Module / 8-Module)",
  ...
  {
    id: "prod-6",
    name: "Multi-Core Flexible PVC Copper Cable",
    category: "Wires & Cables",
    categoryId: "wires-cables",
    brand: "Kundan Cab",
    image: "/images/wires-cables.jpg",
  ...
  {
    id: "prod-7",
    name: "Double Pole Residual Current Circuit Breaker (RCCB)",
    category: "Distribution & Protection",
    categoryId: "distribution-protection",
  ...
  {
    id: "prod-8",
    name: "LED Ceiling COB Spotlight (7W / 15W)",
    category: "LED Lighting",
    categoryId: "led-lighting",
    brand: "Philips",
    image: "/images/led-lighting.jpg",
  ...
  {
    id: "prod-9",
    name: "Heavy-Duty Modular Power Socket (16A / 25A)",
    category: "Switches & Accessories",
    categoryId: "switches-accessories",
  ...
  {
    id: "prod-10",
    name: "Flush-Mount Metal Distribution Board (TPN DB Box)",
    category: "Distribution & Protection",
    categoryId: "distribution-protection",
    brand: "Legrand",
    image: "/images/distribution-boards.jpg",
  ...
  {
    id: "prod-11",
    name: "Heavy-Duty Heavy-Gauge PVC Conduit Pipe & Junction Boxes",
  ...
  {
    id: "prod-12",
    name: "Smart Modular USB Fast Charger Socket",
    category: "Modular Electricals",
    categoryId: "modular-electricals",
    brand: "Legrand",
    image: "/images/switches-accessories.jpg",
